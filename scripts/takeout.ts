    ...
    for await (const file of files) {
        if (file.isFile && file.name.endsWith(".json")) {
            ...
            if (!json.isTrashed && !json.isArchived) {
                ...
                const markdownFilePath = `${exportBase}/note-${index + 1}.md`;
...
readAndExportFiles("/Users/jiujianian/Downloads/Takeout/Keep", '/Users/jiujianian/Documents/my_docs/2024-07-31');
